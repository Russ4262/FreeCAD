...
FeatureExtensions = PathFeatureExtensions
...
class TaskPanelExtensionPage(PathTaskPanelPage.TaskPanelPage):
    ...
    def getForm(self):
        ...
        #    FreeCAD.getUserAppDataDir() + "Mod/PathExp/GuiSupport/PageExtensionsEdit.ui"
        # )
        form.enableExtensions.setCheckable(True)
    ...
    def currentExtensions(self):
        ...
        def extractExtension_orig(item, ext):
