...
import PathScripts.operations.PathTargetShape as PathTargetShape
import PathScripts.taskpanels.PathTaskPanelPage as PathTaskPanelPage

from PySide import QtCore

__title__ = "Path TargetShape Operation UI"
__author__ = "russ4262 (Russell Johnson)"
__url__ = "https://www.freecadweb.org"
__doc__ = "TargetShape object page controller and command implementation."
...
class TaskPanelOpPage(PathTaskPanelPage.TaskPanelPage):
    """Page controller class for TargetShape object"""
    ...
    def initPage(self, obj):
        ...
        self.setTitle("TargetShape - " + obj.Label)
...
Command = PathOpGui.SetupOperation(
    "TargetShape",
    PathTargetShape.Create,
    TaskPanelOpPage,
    "LinkSub",
    QtCore.QT_TRANSLATE_NOOP("Path_TargetShape", "TargetShape"),
    QtCore.QT_TRANSLATE_NOOP(
        "Path_TargetShape",
        "Creates a Path TargetShape operation from edges, wires, faces or solids.",
    ),
    PathTargetShape.SetupProperties,
)

FreeCAD.Console.PrintLog("Loading PathTargetShapeGui... done\n")
