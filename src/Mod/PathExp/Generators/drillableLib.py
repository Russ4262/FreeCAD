...
def getDrillableTargets(shp, ToolDiameter=None, vector=App.Vector(0, 0, 1)):
    """
    Returns a list of names for drillable subelements from the given object
    ['Face1', 'Face3']
    ...
    for i in range(1, len(shp.Faces)):
        ...
        candidate = shp.getElement(fname)
