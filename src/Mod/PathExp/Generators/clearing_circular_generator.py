...
__title__ = "Path Circular Clearing Generator"
__author__ = "russ4262 (Russell Johnson)"
__url__ = "https://www.freecadweb.org"
__doc__ = "Generates the circular clearing toolpath for a single 2D face"
...
class CircularClearingGenerator:
    """CircularClearingGenerator() class...
    ...
    def __init__(
        ...
        """__init__(targetFace,
                ...
                keepToolDown,
                jobTolerance)...
        CircularClearingGenerator class constructor method.
        """
        PathLog.debug("CircularClearingGenerator.__init__()")
        PathLog.track(
    ...
    def _debugMsg(self, msg, isError=False):
        ...
        """
        if isError:
            PathLog.error("CircularClearingGenerator: " + msg + "\n")
            return

        if self.isDebug:
            # PathLog.info(msg)
            FreeCAD.Console.PrintMessage("CircularClearingGenerator: " + msg + "\n")
        else:
            PathLog.debug(msg)
    ...
    def _generatePathGeometry(self):
        ...
        self.rawGeoList = self._Circular()
    ...
    def generate(self):
        """generate()...
        Call this method to execute the path generation code in CircularClearingGenerator class.
        ...
        if hasattr(self.targetFace, "Area") and PathGeom.isRoughly(
            ...
            self._debugMsg("CircularClearingGenerator: No area in working shape.")
            return False
        ...
        return self.startCommands + self._buildLinePaths()
