...
class ViewProvider(object):
        ...
        if 0 == mode:
            ...
            self.setupTaskPanel(
                PathTaskPanel.TaskPanel(
                    vobj.Object, self.deleteObjectsOnReject(), page, selection
                )
            )
    ...
    def setupContextMenu(self, vobj, menu):
        ...
        action = QtGui.QAction(translate("PathShape", "Edit"), menu)
...
class CommandSetStartPoint:
    ...
    def GetResources(self):
        return {
            ...
            "MenuText": QT_TRANSLATE_NOOP("PathShape", "Pick Start Point"),
            "ToolTip": QT_TRANSLATE_NOOP("PathShape", "Pick Start Point"),
        }
...
def Create(res):
    ...
    try:
        ...
        msg = translate(
            "PathShape", "No suitable tool controller found.\nAborting op creation"
        )
        diag = QtGui.QMessageBox(QtGui.QMessageBox.Warning, "Error", msg)
        diag.setWindowModality(QtCore.Qt.ApplicationModal)
        diag.exec_()
    except PathShape.PathNoTCException:
        PathLog.warning(
            translate("PathShape", "No tool controller, aborting op creation")
        )
...
FreeCAD.Console.PrintMessage("Loading PathOpGui module\n")
