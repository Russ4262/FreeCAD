...
class ObjectOp2(object):
    ...
    def updateDepths(self, obj, ignoreErrors=False):
        ...
        elif hasattr(obj, "TargetShape") and obj.TargetShape:
            # base auto depths on TargetShape of object
            # print("PathOp2.updateDepths() updated based upon TargetShape")
            zmax = obj.TargetShape.Shape.BoundBox.ZMax
            zmin = obj.TargetShape.Shape.BoundBox.ZMin
