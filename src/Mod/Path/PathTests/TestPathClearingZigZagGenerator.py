...
import Path
import FreeCAD
import Generators.clearing_zigzag_generator as generator
...
class TestPathClearingZigZagGenerator(PathTestUtils.PathTestBase):
    @classmethod
    def setUpClass(cls):
        """setUpClass()...
        ...
        doc.Shape001.Placement.Base = FreeCAD.Vector(50, 50, 0)
    ...
    def test00(self):
        """Test ZigZab Clearing Generator Return"""
    ...
    def test01(self):
        """Test ZigZab Clearing Generator argument types and value limits"""
    ...
    def test02(self):
        """Test ZigZab Clearing Generator verify keepToolDown feature"""
