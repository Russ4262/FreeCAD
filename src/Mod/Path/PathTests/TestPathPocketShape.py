...
class TestPathPocketShape(PathTestBase):
    ...
    def test00(self):
        ...
        self._set_depths_and_heights(pocketShape)
    ...
    def test03(self):
        ...
        # Set additional operation properties
        self._set_depths_and_heights(pocketShape, finDep=5.0)
        # pocketShape.FinalDepth.Value = 5.0
...
expected_moves_test00 = "G1 X22.5 Y-17.5 Z0.0;  \
G1 X17.5 Y-17.5 Z0.0;  \
G1 X17.5 Y-22.5 Z0.0;  \
G1 X22.5 Y-22.5 Z0.0;  \
G1 X22.5 Y-17.5 Z0.0;  \
G1 X20.0 Y-20.0 Z0.0;  \
G3 I0.0 J-0.0 K0.0 X20.0 Y-20.0 Z0.0;  \
G3 I0.0 J0.0 K0.0 X20.0 Y-20.0 Z0.0;  \
G3 I-0.0 J0.0 K0.0 X20.0 Y-20.0 Z0.0"


expected_moves_test01 = "G1 X32.5 Y-22.5 Z0.0;  \
G1 X22.5 Y-22.5 Z0.0;  \
G1 X22.5 Y-32.5 Z0.0;  \
G1 X22.76 Y-32.5 Z0.0;  \
G2 I12.21 J-2.47 K0.0 X32.5 Y-22.76 Z0.0;  \
G1 X32.5 Y-22.5 Z0.0;  \
G1 X27.1 Y-23.75 Z0.0;  \
G1 X23.75 Y-23.75 Z0.0;  \
G1 X23.75 Y-27.1 Z0.0;  \
G2 I11.2 J-7.85 K0.0 X27.1 Y-23.75 Z0.0"


expected_moves_test02 = "G1 X25.0 Y-15.0 Z15.0;  \
G1 X25.0 Y-25.0 Z15.0;  \
G2 I-0.0 J0.0 K0.0 X25.0 Y-25.0 Z15.0;  \
G1 X20.0 Y-25.0 Z15.0;  \
G1 X20.0 Y-22.5 Z15.0;  \
G1 X20.0 Y-20.0 Z15.0;  \
G1 X20.0 Y-20.0 Z15.0;  \
G2 I0.0 J0.0 K0.0 X20.0 Y-20.0 Z15.0;  \
G2 I-0.0 J-0.0 K0.0 X20.0 Y-20.0 Z15.0;  \
G1 X20.0 Y-22.5 Z15.0;  \
G1 X20.0 Y-25.0 Z15.0;  \
G1 X15.0 Y-25.0 Z15.0;  \
G2 I0.0 J0.0 K0.0 X15.0 Y-25.0 Z15.0;  \
G1 X15.0 Y-15.0 Z15.0;  \
G2 I0.0 J-0.0 K0.0 X15.0 Y-15.0 Z15.0;  \
G1 X25.0 Y-15.0 Z15.0;  \
G2 I-0.0 J-0.0 K0.0 X25.0 Y-15.0 Z15.0;  \
...
expected_moves_test03 = "G1 X32.5 Y32.5 Z5.0;  \
G1 X17.5 Y32.5 Z5.0;  \
G1 X17.5 Y17.5 Z5.0;  \
G1 X32.5 Y17.5 Z5.0;  \
G1 X32.5 Y32.5 Z5.0;  \
...
G1 X27.5 Y27.5 Z5.0;  \
G1 X25.0 Y25.0 Z5.0;  \
G3 I0.0 J-0.0 K0.0 X25.0 Y25.0 Z5.0;  \
G3 I-0.0 J0.0 K0.0 X25.0 Y25.0 Z5.0"
