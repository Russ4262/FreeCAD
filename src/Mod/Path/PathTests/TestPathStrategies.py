...
import PathScripts.PathPocketShape as PocketShape
if FreeCAD.GuiUp:
    import FreeCADGui
    import PathScripts.PathPocketShapeGui as PocketShapeGui
    import PathScripts.PathJobGui as PathJobGui

StrategyClearing = PocketShape.PathPocketBase.PathAreaOp.StrategyClearing
...
class TestPathStrategies(PathTestBase):
    ...
    # Circular pattern
    def test00(self):
        '''test00() Verify Circular Climb cut pattern start at Edge.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test00 Circular Climb Edge'
        op.Comment = 'Verify Circular Climb cut pattern start at Edge.'
        op.CutMode = 'Climb'
        op.OffsetPattern = 'Circular'
        op.StartAt = 'Edge'
    ...
    def test01(self):
        '''test01() Verify Circular Climb cut pattern start at Edge.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test01 Circular Climb Center'
        op.Comment = 'Verify Circular Climb cut pattern start at Center.'
        op.CutMode = 'Climb'
        op.OffsetPattern = 'Circular'
        op.StartAt = 'Center'
        op.Base = [(findModelForBase(self.job, 'CircleLarge'), ['Face1'])]
    ...
    def test02(self):
        '''test02() Verify Circular Conventional cut pattern start at Edge.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test02 Circular Conventional Edge'
        op.Comment = 'Verify Circular Conventional cut pattern start at Edge.'
    ...
    def test03(self):
        '''test03() Verify Circular Conventional cut pattern start at Edge.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test03 Circular Conventional Center'
        op.Comment = 'Verify Circular Conventional cut pattern start at Center.'
        op.CutMode = 'Conventional'
        op.OffsetPattern = 'Circular'
        op.StartAt = 'Center'
        op.Base = [(findModelForBase(self.job, 'CircleLarge'), ['Face1'])]
    ...
    # Line pattern
    def test04(self):
        '''test04() Verify Line Climb cut pattern start at Edge.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test04 Line Climb Edge'
        op.Comment = 'Verify Line Climb cut pattern start at Edge.'
        op.OffsetPattern = 'Line'
        op.ZigZagAngle = 0.0
        op.CutMode = 'Climb'
        op.StartAt = 'Edge'
    ...
    def test05(self):
        '''test05() Verify Line Climb cut pattern start at Center.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test05 Line Climb Center'
        op.Comment = 'Verify Line Climb cut pattern start at Center.'
        op.OffsetPattern = 'Line'
        op.ZigZagAngle = 0.0
        op.CutMode = 'Climb'
        op.StartAt = 'Center'
    ...
    def test06(self):
        '''test06() Verify Line Conventional cut pattern start at Edge.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test06 Line Conventional Edge'
        op.Comment = 'Verify Line Conventional cut pattern start at Edge.'
        op.OffsetPattern = 'Line'
        op.ZigZagAngle = 0.0
        op.CutMode = 'Conventional'
        op.StartAt = 'Edge'
    ...
    def test07(self):
        '''test07() Verify Line Conventional cut pattern start at Center.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test07 Line Conventional Center'
        op.Comment = 'Verify Line Conventional cut pattern start at Center.'
        op.OffsetPattern = 'Line'
        op.ZigZagAngle = 0.0
        op.CutMode = 'Conventional'
        op.StartAt = 'Center'
    ...
    # ZigZag pattern
    def test08(self):
        '''test08() Verify ZigZag Climb cut pattern start at Edge.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test08 ZigZag Climb Edge'
        op.Comment = 'Verify ZigZag Climb cut pattern start at Edge.'
        op.OffsetPattern = 'ZigZag'
        op.ZigZagAngle = 0.0
        op.CutMode = 'Climb'
        op.StartAt = 'Edge'
        op.Base = [(findModelForBase(self.job, 'SquareLarge'), ['Face1'])]
    ...
    def test09(self):
        '''test09() Verify ZigZag Climb cut pattern start at Center.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test09 ZigZag Climb Center'
        op.Comment = 'Verify ZigZag Climb cut pattern start at Center.'
        op.OffsetPattern = 'ZigZag'
        op.ZigZagAngle = 0.0
        op.CutMode = 'Climb'
        op.StartAt = 'Center'
    ...
    def test10(self):
        '''test10() Verify ZigZag Conventional cut pattern start at Edge.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test10 ZigZag Conventional Edge'
        op.Comment = 'Verify ZigZag Conventional cut pattern start at Edge.'
        op.OffsetPattern = 'ZigZag'
        op.ZigZagAngle = 0.0
        op.CutMode = 'Conventional'
        op.StartAt = 'Edge'
    ...
    def test11(self):
        '''test11() Verify ZigZag Conventional cut pattern start at Center.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test11 ZigZag Conventional Center'
        op.Comment = 'Verify ZigZag Conventional cut pattern start at Center.'
        op.OffsetPattern = 'ZigZag'
        op.ZigZagAngle = 0.0
        op.CutMode = 'Conventional'
        op.StartAt = 'Center'
    ...
    # Offset pattern
    def test12(self):
        '''test12() Verify Offset Climb cut pattern start at Edge.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test12 Offset Climb Edge'
        op.Comment = 'Verify Offset Climb cut pattern start at Edge.'
        op.OffsetPattern = 'Offset'
        op.ZigZagAngle = 0.0
        op.CutMode = 'Climb'
        op.StartAt = 'Edge'
        op.Base = [(findModelForBase(self.job, 'SquareLarge'), ['Face1'])]
    ...
    def test13(self):
        '''test13() Verify Offset Climb cut pattern start at Center.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test13 Offset Climb Center'
        op.Comment = 'Verify Offset Climb cut pattern start at Center.'
        op.OffsetPattern = 'Offset'
        op.ZigZagAngle = 0.0
        op.CutMode = 'Climb'
        op.StartAt = 'Center'
    ...
    def test14(self):
        '''test14() Verify Offset Conventional cut pattern start at Edge.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test14 Offset Conventional Edge'
        op.Comment = 'Verify Offset Conventional cut pattern start at Edge.'
        op.OffsetPattern = 'Offset'
        op.ZigZagAngle = 0.0
        op.CutMode = 'Conventional'
        op.StartAt = 'Edge'
    ...
    def test15(self):
        '''test15() Verify Offset Conventional cut pattern start at Center.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test15 Offset Conventional Center'
        op.Comment = 'Verify Offset Conventional cut pattern start at Center.'
        op.OffsetPattern = 'Offset'
        op.ZigZagAngle = 0.0
        op.CutMode = 'Conventional'
        op.StartAt = 'Center'
    ...
    # Spiral pattern
    def test16(self):
        '''test16() Verify Spiral Climb cut pattern start at Edge.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test16 Spiral Climb Edge'
        op.Comment = 'Verify Spiral Climb cut pattern start at Edge.'
        op.OffsetPattern = 'Spiral'
        op.ZigZagAngle = 0.0
        op.CutMode = 'Climb'
        op.StartAt = 'Edge'
        op.Base = [(findModelForBase(self.job, 'SquareLarge'), ['Face1'])]
    ...
    def test17(self):
        '''test17() Verify Spiral Climb cut pattern start at Center.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test17 Spiral Climb Center'
        op.Comment = 'Verify Spiral Climb cut pattern start at Center.'
        op.OffsetPattern = 'Spiral'
        op.ZigZagAngle = 0.0
        op.CutMode = 'Climb'
        op.StartAt = 'Center'
    ...
    def test18(self):
        '''test18() Verify Spiral Conventional cut pattern start at Edge.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test18 Spiral Conventional Edge'
        op.Comment = 'Verify Spiral Conventional cut pattern start at Edge.'
        op.OffsetPattern = 'Spiral'
        op.ZigZagAngle = 0.0
        op.CutMode = 'Conventional'
        op.StartAt = 'Edge'
    ...
    def test19(self):
        '''test19() Verify Spiral Conventional cut pattern start at Center.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test19 Spiral Conventional Center'
        op.Comment = 'Verify Spiral Conventional cut pattern start at Center.'
        op.OffsetPattern = 'Spiral'
        op.ZigZagAngle = 0.0
        op.CutMode = 'Conventional'
        op.StartAt = 'Center'
    ...
    # LineOffset pattern
    def test20(self):
        '''test20() Verify LineOffset Climb cut pattern start at Edge.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test20 LineOffset Climb Edge'
        op.Comment = 'Verify LineOffset Climb cut pattern start at Edge.'
        op.OffsetPattern = 'LineOffset'
        op.ZigZagAngle = 0.0
        op.CutMode = 'Climb'
        op.StartAt = 'Edge'
    ...
    def test21(self):
        '''test21() Verify LineOffset Climb cut pattern start at Center.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test21 LineOffset Climb Center'
        op.Comment = 'Verify LineOffset Climb cut pattern start at Center.'
        op.OffsetPattern = 'LineOffset'
        op.ZigZagAngle = 0.0
        op.CutMode = 'Climb'
        op.StartAt = 'Center'
    ...
    def test22(self):
        '''test22() Verify LineOffset Conventional cut pattern start at Edge.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test22 LineOffset Conventional Edge'
        op.Comment = 'Verify LineOffset Conventional cut pattern start at Edge.'
        op.OffsetPattern = 'LineOffset'
        op.ZigZagAngle = 0.0
        op.CutMode = 'Conventional'
        op.StartAt = 'Edge'
    ...
    def test23(self):
        '''test23() Verify LineOffset Conventional cut pattern start at Center.'''
        op = PocketShape.Create('Pocket_Shape')
        op.Label = 'test23 LineOffset Conventional Center'
        op.Comment = 'Verify LineOffset Conventional cut pattern start at Center.'
        op.OffsetPattern = 'LineOffset'
        op.ZigZagAngle = 0.0
        op.CutMode = 'Conventional'
        op.StartAt = 'Center'
...
def _addViewProvider(op):
    if FreeCAD.GuiUp:
        PathOpGui = PocketShapeGui.PathOpGui
        cmdRes = PocketShapeGui.Command.res
