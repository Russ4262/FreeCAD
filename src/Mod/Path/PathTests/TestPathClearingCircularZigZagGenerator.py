...
import Path
import FreeCAD
import Generators.clearing_circular_zigzag_generator as generator
...
class TestPathClearingCircularZigZagGenerator(PathTestUtils.PathTestBase):
    @classmethod
    def setUpClass(cls):
        """setUpClass()...
    ...
    def test02(self):
        """Test Circular ZigZag Clearing Generator verify keepToolDown feature"""
