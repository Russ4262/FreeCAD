...
import PathScripts.strategies.PathGeometryGenerator as GeometryGenerator
...
PathStrategyAdaptive = LazyLoader(
    "PathScripts.strategies.PathStrategyAdaptive",
    globals(),
    "PathScripts.strategies.PathStrategyAdaptive",
)
TargetBuildUtils = LazyLoader(
    "PathScripts.strategies.PathTargetBuildUtils",
    globals(),
    "PathScripts.strategies.PathTargetBuildUtils",
)
