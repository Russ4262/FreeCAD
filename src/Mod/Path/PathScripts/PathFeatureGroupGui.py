...
import FreeCAD
import FreeCADGui
import PathScripts.PathFeatureGroup as PathFeatureGroup
import PathScripts.PathOpGui as PathOpGui


__title__ = "Path Feature Group object UI"
__author__ = "Russ4262 (Russell Johnson)"
__url__ = "https://www.freecadweb.org"
__doc__ = "Feature Group operation page controller and command implementation."
...
Command = PathOpGui.SetupOperation('FeatureGroup', PathFeatureGroup.Create, TaskPanelOpPage,
                'Path_Area_Workplane',
                QtCore.QT_TRANSLATE_NOOP("Path_FeatureGroup", "Feature Group"),
                QtCore.QT_TRANSLATE_NOOP("Path_FeatureGroup", "Create an independent feature group as source for import into operations Base Geometry"),
                PathFeatureGroup.SetupProperties)

FreeCAD.Console.PrintLog("Loading PathFeatureGroupGui... done\n")
