    ...
    def commandsForEdges(self):
        ...
        if self.edges:
            try:
                ...
                commands = []
                rapid = None
                ordered_and_flipped = self.orderAndFlipEdges(
                    self.cleanupEdges(shape.Edges)
                )
        ...
        for baseWire in self.base_wire_list:
            ...
            PathLog.debug(
                ...
                % (
                    baseWire.Length,
                    shortestEdge.Length,
                    shortestEdge.Length / baseWire.Length,
                    longestEdge.Length,
                    longestEdge.Length / baseWire.Length,
                    minLength,
                )
            )
            PathLog.debug(
