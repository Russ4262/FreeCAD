...
class StrategyClearVolume:
    ...
    def _getPathGeometry(self, face):
        ...
        pGG.execute()
        self.centerOfPattern = pGG.centerOfPattern  # Transfer center of cut pattern
    ...
    def _buildPaths(self, height, wireList):
        ...
        if self.cutPattern in ["Line", "LineOffset", "ZigZag", "ZigZagOffset"]:
    ...
    def _buildLinePaths(self, height, wireList):
        """_buildOffsetPaths(height, wireList) ... Convert Line-based wires to paths."""
        PathLog.debug("_buildOffsetPaths()")
