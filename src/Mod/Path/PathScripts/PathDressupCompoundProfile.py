...
__Title__   = "Dressup Compound Profile"
...
if FreeCAD.GuiUp:
    DressupCompoundProfile = CompoundProfileGui()
    # jobs = DressupCompoundProfile.execute()  # Uncomment for GUI macro and set CompoundProfile.isMacro=True
