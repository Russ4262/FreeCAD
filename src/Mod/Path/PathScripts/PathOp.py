...
# FeatureHeights      = 0x0004     # ClearanceHeight, SafeHeight - Combined with FeatureDepths
...
class ObjectOp(object):
    ...
    The currently supported features are:
        ...
        # FeatureHeights       ... Heights, safe and clearance - Combined with FeatureDepths
    ...
    def setEditorModes(self, obj):
        ...
        for prop in ["AreaParams", "PathParams", "WorkingShape"]:
            if hasattr(obj, prop):
    ...
    def _setMisingClassVariables(self, obj):
        """_setMisingClassVariables(obj)... This method is necessary for the `shapeIdentification()` method."""
    ...
    def execute(self, obj):
        ...
        if self.commandlist and (FeatureDepths & self.features):
    ...
    def opFeatures(self, obj):
        ...
        "FeatureTool | FeatureDepths | FeatureStartPoint | FeatureBaseGeometry | FeatureFinishDepth | FeatureCoolant"
    ...
    def shapeIdentification(self, obj, isPreview=False):
        """shapeIdentification(obj, isPreview=False) ...
