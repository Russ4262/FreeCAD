...
# *   by Russell Johnson  <russ4262@gmail.com>  2020-03-22 17:00 CST        *
# *                                                                         *
# ***************************************************************************
...
class ObjectSurface(PathOp.ObjectOp):
    ...
    def initOperation(self, obj):
        ...
        obj.addProperty("App::PropertyEnumeration", "BoundBox", "Surface", QtCore.QT_TRANSLATE_NOOP("App::Property", "Should the operation be limited by the stock object or by the bounding box of the base object"))
        ...
        obj.addProperty("App::PropertyEnumeration", "DropCutterDir", "Surface", QtCore.QT_TRANSLATE_NOOP("App::Property", "The direction along which dropcutter lines are created"))
        obj.addProperty("App::PropertyVectorDistance", "DropCutterExtraOffset", "Surface", QtCore.QT_TRANSLATE_NOOP("App::Property", "Additional offset to the selected bounding box"))
        ...
        obj.addProperty("App::PropertyEnumeration", "ScanType", "Surface", QtCore.QT_TRANSLATE_NOOP("App::Property", "Planar: Flat, 3D surface scan.  Rotational: 4th-axis rotational scan."))
        ...
        obj.addProperty("App::PropertyEnumeration", "LayerMode", "Surface Cut Options", QtCore.QT_TRANSLATE_NOOP("App::Property", "The completion mode for the operation: single or multi-pass"))
    ...
    def setEditorProperties(self, obj):
        # Used to show and hide properties in Data tab
    ...
    def _processCutAreas(self, JOB, obj, mdlIdx, FCS, VDS):
        ...
        It then calls the correct scan method depending on ScanType.'''
